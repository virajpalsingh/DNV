...
<section id="contact" class="padding">
  <div class="container">
    <div class="row padding-bottom">
      <div class="col-md-4 contact_address heading_space wow fadeInLeft" data-wow-delay="4500ms">
        ...
        <div class="address">
          ...
          <h4>Visit Us</h4>
          <p>Plot No 3 Ward 9/A GANDHIDHAM 370240 </p>
        </div>
        <div class="address">
          <i class="icon icon-mail border_radius"></i>
          <h4>Email Us</h4>
          <p><a href="mailto:dnvacademy@gmail.com">dnvacademy@gmail.com</a></p>
        </div>
        <div class="address">
          <i class="icon icon-phone4 border_radius"></i>
          <h4>Call Us</h4>
          <p>02836 257334 , 8347494566 </p>
        </div>
      ...
      <div class="col-md-8 wow fadeInRight" data-wow-delay="4500ms">
        ...
        <form class="form-inline findus" id="contact-form" onSubmit="return false">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-4">
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Mobile No" name="mobile" id="mobile" required>
              </div>
            </div>
            <div class="col-md-12">
    ...
    <div class="row wow bounceIn" data-wow-delay="300ms">
      <div class="col-md-12">
        <div id="maap">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3670.436438928123!2d70.11284131454723!3d23.081113984923462!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3950b9a6d9e504df%3A0xe7cc4be6535f8814!2sDNV+International+Education+Academy!5e0!3m2!1sen!2sin!4v1501330798106" width="1150" height="500" frameborder="0" style="border:0" allowfullscreen></iframe>
        </div>
      </div>
    </div>
  </div>
