...
<section id="gallery" class="padding">
  <div class="container">
    ...
    <div id="projects" class="cbp">
      <div class="cbp-item course">
        ...
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/gallery/gal1.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a> 
          </div>
        </div>
      </div>
      <div class="cbp-item course book">
        <img src="images/gallery/gal10.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/gallery/gal10.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a> 
          </div>
        </div>
      </div>
      <div class="cbp-item teacher">
        <img src="images/gallery/gal11.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/gallery/gal11.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a> 
          </div>
        </div>
      </div>
      <div class="cbp-item course book">
        <img src="images/gallery/gal12.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/gallery/gal12.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a> 
          </div>
        </div>
      </div>
      <div class="cbp-item student event">
        <img src="images/gallery/gal13.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/gallery/gal13.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a> 
          </div>
        </div>
      </div>
      <div class="cbp-item student">
        <img src="images/gallery/gal14.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/gallery/gal14.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a> 
          </div>
        </div>
      </div>
      <div class="cbp-item event">
        <img src="images/gallery/gal15.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/gallery/gal15.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a> 
          </div>
        </div>
      </div>
      <div class="cbp-item event">
        <img src="images/gallery/gal16.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/gallery/gal16.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a> 
          </div>
        </div>
      </div>
      <div class="cbp-item student event">
        <img src="images/gallery/gal17.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/gallery/gal17.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a> 
          </div>
        </div>
      </div>
      <div class="cbp-item teacher">
        <img src="images/gallery/gal18.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/gallery/gal19.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a> 
          </div>
        </div>
      </div>
      <div class="cbp-item student">
        <img src="images/gallery/gal19.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/gallery/gal19.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a> 
          </div>
      ...
      <div class="cbp-item teacher">
        <img src="images/gallery/gal24.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/gallery/gal24.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a> 
          </div>
        </div>
      </div>
      <div class="cbp-item book student">
        ...
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/gallery/gal8.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a> 
          </div>
        </div>
      </div>
    </div>
