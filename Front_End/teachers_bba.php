    ...
    <div class="row">
      <div class="col-sm-6 col-md-4">
        <div class="teacher margin_top wow fadeIn" data-wow-delay="300ms">
          <div class="image bottom25">
            <img src="images/BBA/rc.JPG" alt="Teachers" class=" border_radius">
            <span class="post">Assistant Lecturer</span>
          </div>
          <h3>Dr.Rashmi P. Chandnani</h3>
      ...
      <div class="col-sm-6 col-md-4">
        <div class="teacher margin_top wow fadeIn" data-wow-delay="400ms">
          <div class="image bottom25">
            <img src="images/BBA/jl.jpg" alt="Teachers" class=" border_radius">
            <span class="post">Assistant Lecturer</span>
          </div>
          <h3>Mrs.Jaya M.Lalwani</h3>
          <p class="bottom20 margin10">We offer the most complete house renovating services in the country, from kitchen design to bathroom remodeling.</p>
          <ul class="social_icon black bottom5">
            <li><a href="#." class="facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="#." class="twitter"><i class="icon-twitter4"></i></a></li>
      ...
      <div class="col-sm-6 col-md-4">
        <div class="teacher margin_top wow fadeIn" data-wow-delay="300ms">
          <div class="image bottom25">
            <img src="images/BBA/ag.jpg" alt="Teachers" class=" border_radius">
            <span class="post">Assistant Lecturer</span>
          </div>
          <h3>Ms.Aleyamma George Parayidayil</h3>
          <p class="bottom20 margin10">We offer the most complete house renovating services in the country, from kitchen design to bathroom remodeling.</p>
          <ul class="social_icon black bottom5">
            <li><a href="#." class="facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="#." class="twitter"><i class="icon-twitter4"></i></a></li>
        ...
        <div class="teacher margin_top wow fadeIn" data-wow-delay="300ms">
          <div class="image bottom25">
            <img src="images/BBA/mr.jpg" alt="Teachers" class=" border_radius">
            <span class="post">Assistant Lecturer</span>
          </div>
          <h3>Mrs.Mamta Rangwani</h3>
          <p class="bottom20 margin10">We offer the most complete house renovating services in the country, from kitchen design to bathroom remodeling.</p>
          <ul class="social_icon black bottom5">
            <li><a href="#." class="facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="#." class="twitter"><i class="icon-twitter4"></i></a></li>
