  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-8 course_detail wow fadeIn" data-wow-delay="400ms">
        <img src="images/A/BCA 1 (800-244).png" alt="Course" class=" border_radius img-responsive bottom15">
        ...
        <h3 class="top30 bottom20">Bachelor in Computer Application (BCA)</h3>
