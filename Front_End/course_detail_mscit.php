  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-8 course_detail wow fadeIn" data-wow-delay="400ms">
        <img src="images/A/MSCIT 1 (800-244).png" alt="Course" class=" border_radius img-responsive bottom15">
        <div class="detail_course">
          <div class="info_label">
            <span class="icony"><i class="icon-users3"></i></span>
            <p>HOD</p>
            <h5>Mr.Sandeep Lodariya</h5>
          </div>
          <div class="info_label">
            <span class="icony"><i class="icon-users3"></i></span>
            <p>Category</p>
        ...
        <h3 class="top30 bottom20">Master of Science in Information Technology</h3>
        ...
        <div class="profile_bg heading_space">
          ...
          <div class="profile">
            ...
            <div class="profile_text">
              <h5><strong>Mr.Sandeep Lodariya</strong>  -  <span>IT Expert</span></h5>
