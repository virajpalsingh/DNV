      ...
      <div class="col-md-12">
        ...
        <ul class="social_top pull-right" >
          ...
          <li class="dropdown" >
            ...
            <a class="dropdown-toggle" href="#" data-toggle="dropdown"> <i class="icon-login"></i></a>
            <div class="dropdown-menu" style="padding: 15px; padding-bottom: 0px; width: 240px;">
             <form method="post" name="p" action="sign_in.php" >
             <input type="text" id="usid1" name="userid" placeholder="Username" style=" margin-top: 10px;">
             <input type="password" type="password" name="password" placeholder="Password" style=" margin-top: 10px;">
             <input type="submit" name="submit" value="Login" class="btn btn-primary" style=" margin-top: 10px;">
             </form>
             <a href="" target="_blank" style="width: 100%; color: black;"> Forgot Password ?</a>
             <a href="" target="_blank" style="width: 100%; color: black;"> Student Registration</a><br>
...
<header>
  ...
  <div class="collapse navbar-collapse" id="navbar-menu">
        ...
        <li class="dropdown">
          ...
          </li>          <li><a href="testinomial.php">Alumni</a></li>
    ...
    <div class="row">
      <div class="col-sm-6 col-md-4">
        <div class="teacher margin_top wow fadeIn" data-wow-delay="300ms">
          <div class="image bottom25">
            <img src="images/BCA/ns1.jpg" alt="Teachers" class=" border_radius">
            <span class="post">Assistant Lecturer</span>
          </div>
          <h3>Mr.Nehal Sheth</h3>
      ...
      <div class="col-sm-6 col-md-4">
        <div class="teacher margin_top wow fadeIn" data-wow-delay="400ms">
          <div class="image bottom25">
            <img src="images/BCA/bs1.jpg" alt="Teachers" class=" border_radius">
            <span class="post">Assistant Lecturer</span>
          </div>
          <h3>Ms.Bhakti Sorathiya</h3>
          <p class="bottom20 margin10">We offer the most complete house renovating services in the country, from kitchen design to bathroom remodeling.</p>
          <ul class="social_icon black bottom5">
            <li><a href="#." class="facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="#." class="twitter"><i class="icon-twitter4"></i></a></li>
