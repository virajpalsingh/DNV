	...
	<body onLoad="document.p.fnam.focus()" bgcolor="LAVENDER">
		...
		<form name="p" method="post" onSubmit="return confirm('Are You Sure To Submit The Form');">
			...
			<div>
				...
				<input type="text" name="funam" id="fullname" placeholder="Full Name" maxlength="100" onBlur="fu()" onKeyPress="return lettersOnly(event)" onChange="genusi()" required>
				<span id="fuerr"></span>
			</div>
			<div>
				<label for="fanam">Father Name&nbsp;</label>
				<input type="text" name="fanam" placeholder="Father Name" maxlength="45" onBlur="fan()" onKeyPress="return lettersOnly(event)" required>
				<span id="faerr"></span>
			</div>
			<div>
...
<option value="1905">1905</option>
			...
			<div>
				...
				<input type="text" name="em" placeholder="Email id eg:abc@gmail.com" maxlength="255" onBlur="ema()" required>
				<span id="emerr"></span>
			</div>
			<div>
				<label for="userid">Faculty Id&nbsp;</label>
				<input type="text" name="userid" id="userid" placeholder="Ram1234" maxlength="30" onkeypress="return IsAlphaNumeric(event);" required>
				<span id="status" style="color: Red; display: none">* Special Characters not allowed</span>
			</div>
			<div>
				<label for="pwd">Password&nbsp;</label>
				<input type="password" name="pwd" placeholder="eg:-Ram@47863" maxlength="255" onBlur="pass()" required>
				<span id="pwderr"></span>
			</div>
			<div>
				<label for="pwde">Cofirm Password&nbsp;</label>
				<input type="password" name="pwde" placeholder="eg:-Ram@47863" maxlength="255" onBlur="pass1()" required>
			...
			<div>
				...
				<input type="text" name="seca" placeholder="eg:-ram" maxlength="60" onKeyPress="return lettersOnly(event)" onBlur="secan()" required>
